      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form action class="form" enctype="multipart/form-data" @submit.prevent="actualizarInformacionFinanciera">
...
export default {
  ...
  methods: {
    ...
    actualizarInformacionFinanciera () {
      ...
      if (this.errors.length > 0) {
        ...
        let idif = this.$route.params.idif
              ...
              if (segundoarchivo != null) {
                ...
                axios({
                  ...
                  .then(function (response) {
                    ...
                    loader.hide()
                    axios
                      .put(process.env.API_URL + 'informacion-financiera', { id_informacion_financiera: idif, anho: clase.anho, nombre: clase.nombre, nombre_en: clase.nombre_en, trimestre: clase.trimestre, archivo: clase.archivo, archivo_en: clase.archivo_en })
                      .then((response) => clase.$router.push('/informacion_financiera?mensaje=actualizada'))
                ...
                axios
                  ...
                  .then(function (response) {
                    loader.hide()
                    clase.$router.push('/informacion_financiera?mensaje=actualizada')
                  })
                  .catch(function (response) {
                    loader.hide()
                  })
  ...
  mounted () {
    let idif = this.$route.params.idif
    axios
      .post(process.env.API_URL + 'detalle-informacion-financiera', {id_informacion_financiera: idif})
      .then((response) => {
        ...
        if (response.data.link) {
          document.getElementById('archivo_enlace').href = process.env.ARCHIVOS_URL + response.data.link
          document.getElementById('archivo_enlace').text = '>> ' + response.data.link
        }
        if (response.data.informacion_financiera_idiomas[0].link) {
          document.getElementById('archivo_en_enlace').href = process.env.ARCHIVOS_URL + response.data.informacion_financiera_idiomas[0].link
